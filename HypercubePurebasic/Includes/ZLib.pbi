...
;MessageRequester("Old Include!", "Don't use that include (ZLib.pbi) anymore, check your pb-root for the right one!")
...
Structure gz_header
    ...
    *comment        ; pointer to zero-terminated comment or Z_NULL
    ...
    hcrc.i          ; true if there was or will be a header crc
    done.i          ; true when done reading gzip header (not used when writing a gzip file)
EndStructure
...
CompilerSelect #PB_Compiler_OS
    CompilerCase #PB_OS_Linux
        CompilerIf #PB_Compiler_Processor = #PB_Processor_x64
            ImportC "ZLib(x64)/zlib.a"
        CompilerElse
            ImportC "ZLib(x86)/zlib.a"
        CompilerEndIf
