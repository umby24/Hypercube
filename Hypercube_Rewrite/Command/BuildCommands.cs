    ...
    internal static class BuildCommands {
        ...
        static void BindHandler(NetworkClient Client, string[] args, string Text1, string Text2) {
            switch (args.Length) {
                ...
                case 1:
                    ...
                    var newBlock = Client.ServerCore.Blockholder.GetBlock(args[0]);
                    ...
                    break;
                case 2:
                    var newBlocka = Client.ServerCore.Blockholder.GetBlock(args[0]);
                    ...
                    var materialBlock = Client.ServerCore.Blockholder.GetBlock(args[1]);
        ...
        static void MaterialHandler(NetworkClient Client, string[] args, string Text1, string Text2) {
            if (args.Length == 0) {
                ...
                Client.CS.MyEntity.BuildMaterial = Client.ServerCore.Blockholder.GetBlock("");
                return;
            }
